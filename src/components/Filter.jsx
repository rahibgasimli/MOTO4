...
import ArrDown from "../images/home/arrow-down.svg"
...
const Filter = () => {
    ...
    return (
    <>
    <div  className={`container ${isFilterHidden ? 'hidden' : ''}`}  style={{ width: isFilterHidden ? '1224px' : '1224px', height: isFilterHidden ? '229px' : 'auto' }}>

<div className="inputForms">
  <section  className={`${isFilterHidden ? 'hidden' : ''}`}>
    <div className="row-1">
  ...
  <section >
    <div className="row7">
        ...
        <div className="btn-cent">
            ...
            <p className="hide" onClick={handleHideClick}>{isFilterHidden ? 'Show More Filters' : 'Gizlət'} <img src={ArrDown} alt="" /></p>
  <button className="showResult">Elanları Göstər</button>

        </div>
    </div>
    {isFilterHidden && (
<div className="show-more-filters" onClick={handleShowMoreFiltersClick}>
  Show More Filters
</div>
)}
  </section>
